...
set DESIGN_FILES_sv2   "${IPS}/axi/axi_slice/axi_buffer.sv \
...
set DESIGN_FILES_sv4   "${IPS}/adv_dbg_if/rtl/adbg_axi_module.sv \
						${IPS}/adv_dbg_if/rtl/adbg_lint_biu.sv \
						${IPS}/adv_dbg_if/rtl/adbg_lint_module.sv \
						${IPS}/adv_dbg_if/rtl/adbg_or1k_biu.sv"

set DESIGN_FILES_v5	   "${IPS}/adv_dbg_if/rtl/syncflop.v \
						${IPS}/adv_dbg_if/rtl/syncreg.v \
						${IPS}/adv_dbg_if/rtl/bytefifo.v"

set DESIGN_FILES_sv6   "${IPS}/adv_dbg_if/rtl/adbg_or1k_module.sv \
...
set DESIGN_FILES_sv77  "${IPS}/zero-riscy/include/zeroriscy_defines.sv \
						...
						${IPS}/zero-riscy/include/zeroriscy_tracer_defines.sv \
						${IPS}/zero-riscy/zeroriscy_tracer.sv"

set DESIGN_FILES_sv8   "${IPS}/axi/axi_node/axi_BR_allocator.sv \
...
set DESIGN_FILES_sv9   "${IPS}/fpu/hdl/fpu_v0.1/fpu_defs.sv \
...
set DESIGN_FILES_vhd10 "${IPS}/apb/apb_uart/apb_uart.vhd \
...
set DESIGN_FILES_v11   "${RTL}/pulpino_padstop.v "
