...
addHaloToBlock {28 28 28 28} -allBlock
...
#Define CONV RAM Instance group
set conv_banks [get_cells {pulpino_top_i/peripherals_i/apb_conv_i/byte0 \
						pulpino_top_i/peripherals_i/apb_conv_i/byte1 \
						pulpino_top_i/peripherals_i/apb_conv_i/byte2}]

set all_ram_banks [concat $instr_bank0 $instr_bank1 $instr_bank2 $instr_bank3 $data_banks $conv_banks]
